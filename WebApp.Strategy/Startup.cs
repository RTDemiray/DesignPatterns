...
namespace WebApp.Strategy
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Runtime esnasında kullanıcıya hangi db'yi kullanabileceğini seçtiriyoruz ve cookielerde ki claim değerine göre ilgili nesneyi IProductRepository interface register ediyoruz.
